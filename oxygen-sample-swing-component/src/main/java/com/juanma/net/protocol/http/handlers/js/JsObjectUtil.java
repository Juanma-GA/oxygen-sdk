package com.juanma.net.protocol.http.handlers.js;

import java.lang.reflect.Method;

/**
 * Contains utility methods for dealing with a {@link com.juanma.net.protocol.http.handlers.js.JsObject} and <code>netscape.javascript.JSObject</code>
 * 
 * @author alin_balasa
 */
class JsObjectUtil {
  ...
  /**
   * Unwraps a <code>netscape.javascript.JSObject</code> from a {@link com.juanma.net.protocol.http.handlers.js.JsObject}.
   * If the given object is not a {@link com.juanma.net.protocol.http.handlers.js.JsObject} it is returned as is.
   * 
   * @param obj The object to be processed.
   * 
   * @return The wrapped <code>netscape.javascript.JSObject</code> or the provided object if it is not 
   *         an instance of {@link com.juanma.net.protocol.http.handlers.js.JsObject}. 
   */
